<?php
/**
  * Template Name: Big Hero Homepage
  */
?>
...
<div class="tile-group">
  ...
  <div class="container">
    <div class="tiles row">
      ...
      <?php
          $recent = wp_get_recent_posts(array('numberposts' => 3, 'post_status' => 'publish'), OBJECT);
      ?>
          ...
          <a href="<?php echo get_the_permalink( $post->ID ) ?>">
            <div class="tile">
              <?php if ( has_post_thumbnail( $post->ID ) ) : ?>
                <?php echo get_the_post_thumbnail( $post->ID , '', array('class' => 'img-responsive') ); ?>
              <?php endif; ?>
              <div class="tile-text-wrap">
                <div class="title"><?php echo get_the_title( $post->ID ); ?></div>
                <div class="body-text"><p><?php echo get_the_excerpt( $post->ID ); ?></p></div>
